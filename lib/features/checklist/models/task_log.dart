...
class TaskLog {
  ...
  /// สร้าง TaskLog ใหม่โดย copy ค่าเดิมและเปลี่ยนเฉพาะ field ที่ระบุ
  /// ใช้สำหรับ Optimistic Update - อัพเดต UI ทันทีก่อนรอ server ตอบกลับ
  TaskLog copyWith({
    int? logId,
    int? taskId,
    String? title,
    ...
    bool? requireImage,
    String? confirmImage,
    String? confirmVideoUrl,
    String? confirmVideoThumbnail,
    String? formUrl,
    ...
    int? postponeFrom,
    int? postponeTo,
    DateTime? expectedDatePostponeFrom,
    bool? mustCompleteByPost,
    int? assignedRoleId,
    String? assignedRoleName,
    int? taskRepeatId,
    String? sampleImageCreatorId,
    String? sampleImageCreatorNickname,
    String? sampleImageCreatorPhotoUrl,
    String? recurNote,
    ...
    bool clearCompletedByNickname = false,
    ...
    return TaskLog(
      ...
      descript: clearDescript ? null : (descript ?? this.descript),
      ...
      resolvedByNickname: resolvedByNickname ?? this.resolvedByNickname,
      resolvedAt: resolvedAt ?? this.resolvedAt,
      expectedDateTime: expectedDateTime ?? this.expectedDateTime,
      completedAt: clearCompletedAt ? null : (completedAt ?? this.completedAt),
      completedByUid: clearCompletedByUid ? null : (completedByUid ?? this.completedByUid),
      completedByNickname: clearCompletedByNickname ? null : (completedByNickname ?? this.completedByNickname),
      ...
      confirmImage: clearConfirmImage ? null : (confirmImage ?? this.confirmImage),
      confirmVideoUrl: confirmVideoUrl ?? this.confirmVideoUrl,
      confirmVideoThumbnail: confirmVideoThumbnail ?? this.confirmVideoThumbnail,
      ...
      postponeFrom: postponeFrom ?? this.postponeFrom,
      postponeTo: postponeTo ?? this.postponeTo,
      expectedDatePostponeFrom: expectedDatePostponeFrom ?? this.expectedDatePostponeFrom,
      mustCompleteByPost: mustCompleteByPost ?? this.mustCompleteByPost,
      assignedRoleId: assignedRoleId ?? this.assignedRoleId,
      assignedRoleName: assignedRoleName ?? this.assignedRoleName,
      taskRepeatId: taskRepeatId ?? this.taskRepeatId,
      sampleImageCreatorId: sampleImageCreatorId ?? this.sampleImageCreatorId,
      sampleImageCreatorNickname: sampleImageCreatorNickname ?? this.sampleImageCreatorNickname,
      sampleImageCreatorPhotoUrl: sampleImageCreatorPhotoUrl ?? this.sampleImageCreatorPhotoUrl,
      recurNote: recurNote ?? this.recurNote,
